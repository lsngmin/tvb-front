...
const Navigation = () => {
    ...
    return (
        <header className="inset-x-0 top-0 z-10 bg-white/70 backdrop-blur-sm shadow-[0_1px_3px_0_rgb(0,0,0,0.05)]">
                    ...
                    <div className="flex items-center gap-x-10 lg:flex-1">
                        ...
                        <PopoverGroup className="hidden lg:flex lg:gap-x-8">
                            {/* <Popover className="relative z-20">
                                ...
                                <PopoverPanel
                                    transition
                                    className="transition transform absolute top-full -left-8 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5 data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
                                >
                                    <div className="p-4">
                                        {products.map((item) => (
                                            <div
